...
var TableOfContents_default = /* @__PURE__ */ __name((opts) => {
  ...
  const TableOfContents2 = /* @__PURE__ */ __name(({
    ...
    return /* @__PURE__ */ jsxs13("div", { class: classNames(displayClass, "toc"), children: [
      ...
      /* @__PURE__ */ jsx23(OverflowList2, { class: fileData.collapseToc ? "collapsed toc-content" : "toc-content", children: fileData.toc.map((tocEntry) => /* @__PURE__ */ jsx23("li", { class: `depth-${tocEntry.depth}`, children: /* @__PURE__ */ jsx23("a", { href: `#${tocEntry.slug}`, "data-for": tocEntry.slug, children: tocEntry.text }) }, tocEntry.slug)) })
    ] });
  }, "TableOfContents");
    ...
    return /* @__PURE__ */ jsxs14(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx24("div", { class: "explorer-content", "aria-expanded": false, children: /* @__PURE__ */ jsx24(OverflowList2, { class: "explorer-ul" }) }),
...
var config = {
  configuration: {
    pageTitle: "RealityHub",
    pageTitleSuffix: "",
    enableSPA: true,
    enablePopovers: true,
    analytics: { provider: "plausible" },
    locale: "en-US",
    contentFolder: "content-copy",
    baseUrl: "https://210bravo.github.io/RealityHub",
    ignorePatterns: [".obsidian", "private", "*.pdf", "*.docx", "*.mp4", "*.mov", "*.avi", "Videos"],
  ...
  plugins: {
    transformers: [
      ...
      Description(),
      Latex({ renderEngine: "katex", strict: false })
    ],
